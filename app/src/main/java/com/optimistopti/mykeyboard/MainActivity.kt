...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupList() {
        val items = listOf(
            ...
            SettingsItem("📐", "Внешний вид", "Высота, отступы, скругление", AppearanceActivity::class.java),
            SettingsItem("🔊", "Звук и вибрация", "Нажатие, интенсивность", SoundActivity::class.java),
            SettingsItem("⌨️", "Клавиши", "Ряд цифр, запятая, символы", KeysActivity::class.java),
            SettingsItem("✏️", "Ввод текста", "Автокоррекция, подсказки", TextInputActivity::class.java),
        ...
        rv.adapter = object : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            override fun onCreateViewHolder(parent: android.view.ViewGroup, vt: Int): RecyclerView.ViewHolder {
                val v = layoutInflater.inflate(R.layout.item_settings, parent, false)
                return VH(v)
            }
    ...
    private fun updateStatus() {
        ...
        if (enabled) {
            tv.text = "✅ Клавиатура активна"
            tv.setTextColor(0xFF4CAF50.toInt())
        } else {
            tv.text = "⚠️ Нажми «Включить» и выбери My Keyboard"
